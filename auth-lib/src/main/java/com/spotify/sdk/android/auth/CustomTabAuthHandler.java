...
public class CustomTabAuthHandler implements AuthorizationHandler {
    ...
    @Override
    public boolean start(final Activity contextActivity, final AuthorizationRequest request) {
